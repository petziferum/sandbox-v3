<template>
  <v-container fluid>
    ...
    <v-expansion-panels>
      ...
      <wrapper-panel title="NAS Server Gradle Backend Test">
        <v-card>
          ...
          <v-card-text>
            <v-row>
              <v-col class="text-grey">
                Das angesprochene Backend liegt auf dem Nas Server in einem Docker Container. Dort läuft es auf Port
                8080. Das Image ist auf DockerHub und heist "gradlebackend".
              </v-col>
            </v-row>
            <v-row>
              <v-col cols="6">
      ...
      <wrapper-panel title="Rating Component">
        Rating
